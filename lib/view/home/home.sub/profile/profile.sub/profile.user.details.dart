                ...
                children: [
                  ...
                  Row(
                    children: [
                      Column(
                        ...
                        children: [
                          Text(tState).subTitle(fontSize: 12),
                          CW.AppSpacer(h: 5),
                          Container(
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(tLga).subTitle(fontSize: 12),
                          CW.AppSpacer(h: 5),
                          Container(
                  ...
                  CW.button(
                      onPress: () => _.saveUserInfo({
                            "phoneNumber": _.phone.text,
                            "phoneNumber2": _.phone2.text,
                            "fullName": _.fulName.text,
                          }),
                      text: tSave)
                ],
              )
